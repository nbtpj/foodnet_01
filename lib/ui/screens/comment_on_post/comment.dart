...
class CommentComponent extends StatefulWidget{
  ...
  CommentComponent({Key? key, required this.comment, this.isNet=true, this.is_editing=false}) : super(key: key);
  @override
  ...
  Widget build(BuildContext context) {
    return Column(
      children: <Widget>[
        ...
        MediaList(children: [for(String element in widget.comment.mediaUrls)
          GestureDetector(child: MediaWidget(url: element,isNet: widget.isNet,),
          onTap: (){
            setState(() {
